...
import (
	...
	idp "github.com/kkguan/p2pdb-log/identityprovider"
	"github.com/kkguan/p2pdb-log/keystore"
...
func main() {
	...
	// creating log
	log1, err := NewLog(serviceA, identityA, &LogOptions{ID: "A"})
	if err != nil {
		panic(err)
	}

	// creating log
	log2, err := NewLog(serviceB, identityB, &LogOptions{ID: "A"})
	if err != nil {
		panic(err)
	}
	...
	res, err := NewFromMultihash(ctx, serviceA, identityA, h, &LogOptions{}, &FetchOptions{})
	if err != nil {
